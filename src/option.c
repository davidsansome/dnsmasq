...
#define LOPT_RBL_SUFFIX         304
#define LOPT_RBL_DEFAULT_ACTION 305
#define LOPT_RBL_DENY_CATEGORY  306
#define LOPT_RBL_WHITELIST      307
#define LOPT_RBL_BLACKLIST      308
#define LOPT_RBL_BLOCKED_TARGET 309
